...
public class HistorialVista extends javax.swing.JFrame {
    ...
    public HistorialVista() {
        ...
        setTitle("PaperDesk — Historial de Pedidos");
        ...
        java.awt.Color colorBotonBuscar = new java.awt.Color(20, 60, 100);
        java.awt.Font fuenteBoton = new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 12);

        botonBuscarFecha.setBackground(colorBotonBuscar);
        botonBuscarFecha.setForeground(colorBlanco);
        botonBuscarFecha.setFont(fuenteBoton);
        botonBuscarFecha.setFocusPainted(false);
        botonBuscarFecha.setBorderPainted(false);
        botonBuscarFecha.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        botonBuscarNombre.setBackground(colorBotonBuscar);
        botonBuscarNombre.setForeground(colorBlanco);
        botonBuscarNombre.setFont(fuenteBoton);
        botonBuscarNombre.setFocusPainted(false);
        botonBuscarNombre.setBorderPainted(false);
        botonBuscarNombre.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        botonBuscarId.setBackground(colorBotonBuscar);
        botonBuscarId.setForeground(colorBlanco);
        botonBuscarId.setFont(fuenteBoton);
        botonBuscarId.setFocusPainted(false);
        botonBuscarId.setBorderPainted(false);
        botonBuscarId.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        botonMostrarTodos.setBackground(new java.awt.Color(39, 174, 96));
        botonMostrarTodos.setForeground(colorBlanco);
        botonMostrarTodos.setFont(fuenteBoton);
        botonMostrarTodos.setFocusPainted(false);
        ...
        botonCancelar.setForeground(colorBlanco);
        botonCancelar.setFont(fuenteBoton);
        botonCancelar.setFocusPainted(false);
        botonCancelar.setBorderPainted(false);
        botonCancelar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        botonVerEntregas.setBackground(new java.awt.Color(41, 128, 185));
        botonVerEntregas.setForeground(colorBlanco);
        botonVerEntregas.setFont(fuenteBoton);
        botonVerEntregas.setFocusPainted(false);
        botonVerEntregas.setBorderPainted(false);
        botonVerEntregas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        tablaHistorial.getTableHeader().setBackground(new java.awt.Color(20, 60, 100));
        tablaHistorial.getTableHeader().setForeground(colorBlanco);
        tablaHistorial.getTableHeader().setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 13));
        tablaHistorial.setRowHeight(25);
        tablaHistorial.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 12));

        javax.swing.JLabel labelTitulo = new javax.swing.JLabel("Historial de Pedidos");
        labelTitulo.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 24));
        labelTitulo.setForeground(colorBlanco);
